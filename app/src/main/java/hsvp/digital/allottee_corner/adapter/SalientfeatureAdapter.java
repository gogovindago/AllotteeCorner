...
public class SalientfeatureAdapter extends RecyclerView.Adapter<SalientfeatureAdapter.ViewHolder> {
    ...
    public SalientfeatureAdapter(Context context, ArrayList values, ItemListener itemListener) {
